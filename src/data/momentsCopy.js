...
export const momentsCopy = {
  ...
  moment1: {
    ...
    description: 'Tus leads de outbound, inbound, orgánico y referidos llegan a un lugar. Usualmente es una landing page que intenta convertirlos o un canal como WhatsApp. Pero la tasa de conversión es baja y, peor aún, de 10 activaciones, 9 hacen churn en los primeros 10 días.',
  ...
  moment2: {
    ...
    description: 'Solo 1 de cada 10 usuarios permanece activo después de 3 meses. Además, 55% del churn de los primeros 10 días ocurre porque el usuario nunca entendió cómo usar la solución para su caso de uso.',
